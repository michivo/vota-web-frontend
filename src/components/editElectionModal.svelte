		...
		<Form>
			<ModalBody>
                <FormGroup>
					...
					<Input feedback="Geben Sie eine Bezeichnung an" type="text" id="title" bind:value={election.title} placeholder="Listenwahl EU-Wahl Platz 3-5" required />
				</FormGroup>
                <FormGroup>
					<Label for="description">Beschreibung</Label>
					<Input type="text" id="description" bind:value={election.description} placeholder="Optionale ausführliche Beschreibung der Wahl"/>
				</FormGroup>                
                <FormGroup>
                    <Input type="switch" bind:checked={election.enforceGenderParity} label="Geschlechterparität berücksichtigen" />
                </FormGroup>
			</ModalBody>
			<ModalFooter>
